...
#******************************************************************
# def valuesGreaterThanSecond(greaterThan):
#     numAt = 0
#     new_list = []
#     if len(greaterThan) < 2:
#             return False
#     elif len(greaterThan) > 2:
#         for x in range(len(greaterThan)):
#                 if greaterThan[x] > greaterThan[1]:
#                     new_list.append(greaterThan[x])
#                     numAt += 1
#         print(numAt)
#         return new_list
